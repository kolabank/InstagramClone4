...
public class SharePictureTab extends Fragment implements View.OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        imgSharePicture = view.findViewById(R.id.imgSharePicture);
        btnSharePicture = view.findViewById(R.id.btnShareImage);
        edtDescription = view.findViewById(R.id.edtDescription);

        imgSharePicture.setOnClickListener(SharePictureTab.this);
        ...
        switch (v.getId()){
            ...
            case R.id.btnShareImage:
                ...
                if(recievedImageBitmap!=null){
                    ...
                    Toast.makeText(getContext(), "You must select and image", Toast.LENGTH_SHORT).show();
    ...
    // This method is what actually makes the device to access it's picture handling galleries
    ...
    // This is to be called when the user has granted permission
    @Override
    ...
    // This implementation to called after user has selected a picture
    @Override
...
if (requestCode==2000){
    if (resultCode==Activity.RESULT_OK){
        ...
        try{
            ...
            imgSharePicture.setImageBitmap(recievedImageBitmap);
